...
public class ProjectMain {
	...
	private static void searchByMgName() throws Exception {
		Scanner scan = new Scanner(System.in);
		...
		System.out.print("부서장 이름은? : ");
		String departname = scan.nextLine();

		EmpService service = getEmpService();

		while (departname != null && departname != "") {
			List<Emp> list = service.findEmpByManagerName(departname);
			...
			System.out.println("부서장 목록");
			System.out
					.println("Steven King, Alexander Hunold, Nancy Greenberg, Den Raphaely, Adam Fripp, John Russell");
			System.out.println("Jennifer Whalen, Michael Hartstein, Susan Mavris, Hermann Baer, Shelley Higgins");
			System.out.print("부서장 이름(이름+성으로 입력): ");
