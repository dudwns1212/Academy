...
router.route('/view/list-data').get(async(req,res) => {
...
router.route('/view/modify').get(async(req,res) => {
...
router.route('/view/insert').get(async (req, res) => {
...
router.route('/view/delete').get(async (req, res) => {
